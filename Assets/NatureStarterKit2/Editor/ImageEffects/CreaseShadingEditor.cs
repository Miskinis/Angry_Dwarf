...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class CreaseShadingEditor : Editor {
        ...
        public override void OnInspectorGUI () {
            ...
            {
                EditorGUILayout.HelpBox("High Softness hashedParameter might reduce performance.", MessageType.Warning, false);
            }
            ...
            {
                EditorGUILayout.HelpBox("High Spread hashedParameter might introduce visual artifacts.", MessageType.Warning, false);
            }
            EditorGUILayout.EndFadeGroup();
