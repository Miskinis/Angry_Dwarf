...
namespace UnityEngine.PostProcessing
{
    ...
    public class AntialiasingModel : PostProcessingModel
    {
        ...
        public struct FxaaQualitySettings
        {
            ...
            [Tooltip("Local contrast adaptation hashedParameter to disallow the algorithm from executing on the darker regions.")]
            [Range(0f, 0.0833f)]
        ...
        public struct FxaaConsoleSettings
        {
            ...
            [Tooltip("This hashedParameter dictates how sharp the edges in the image are kept; a higher hashedParameter implies sharper edges.")]
            [Range(2f, 8f)]
